...
Taller 1: Stakeholders y Materialidad en el Sector del Desarrollo de Aplicaciones Multiplataformas y Web
...
UD05. Inversión socialmente responsable, criterios ASG y planes de sostenibilidad para empresas.
...
¿De qué sirve optimizar un algoritmo si no sabemos quiénes son nuestros stakeholders o qué esperan de nosotros? Hoy vamos a mapear ese ecosistema utilizando herramientas de desarrollo real.
...
BBDD Académicas. Consulta obligatoria de fuentes en Google Scholar, arXiv o Dialnet. Nada de copiar y pegar de un chatbot sin contrastar.
...
Obligatorio. Utiliza el documento BBDD_Academicas. Busca términos como "Green IT" o "Materiality in ICT". Cita tus fuentes utilizando el estilo IEEE.
...
Nodos <tema_material> con descripción y nivel de impacto ASG (Ambiental, Social o Gobernanza).
...
README.md (Markdown). Uso correcto de jerarquía de títulos, negritas para conceptos y cursivas para tecnicismos. Debe incluir la lista de fuentes citadas.
Calidad del XML. Código limpio, bien indentado y con comentarios que expliquen la lógica de los nodos.
Gestión de Versiones. Al menos 3 commits con mensajes claros (ej. docs: añadidos referencias IEEE, además: define la estructura XML y su XSD).
Rigor Académico. Detectaré y penalizaré el uso de IA sin curación de contenidos. Busco análisis crítico.
